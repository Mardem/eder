<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
      ...
      @if(Auth::user()->can('manage-users'))
          ...
          <li class="{{ Request::route()->getName() == 'admin.users' ? ' active' : '' }}"><a class="nav-link" href="{{ route('admin.users') }}"><i class="fa fa-users"></i> <span>Usuários</span></a></li>
          <li class="dropdown {{ currentActiveMenu('admin/control/pubs*') }}">
              <a href="#" class="nav-link has-dropdown"><i class="ti ti-pencil-alt"></i> <span>Blog</span></a>
              <ul class="dropdown-menu">
                  <li class="{{ currentActiveMenu('admin/control/pubs/categories*') }}"><a class="nav-link" href="{{ route('admin.categories.index') }}"><span>Categorias</span></a></li>
                  <li class="{{ currentActiveMenu('admin/control/pubs/posts*') }}"><a class="nav-link" href="{{ route('admin.posts.index') }}"><span>Publicações</span></a></li>
              </ul>
          </li>
          <li class="{{ currentActiveMenu('admin/control/contacts*') }}"><a class="nav-link" href="{{ route('admin.contacts.index') }}"><i class="ti ti-align-center"></i> <span>Mensagens</span></a></li>
          <li class="{{ currentActiveMenu('admin/control/contacts*') }}"><a class="nav-link" href="{{ route('admin.portfolio.index') }}"><i class="ti ti-image"></i> <span>Portfólio</span></a></li>
      @endif
    </ul>
